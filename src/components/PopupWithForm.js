...
export default class PopupWithForm extends Popup {
  ...
  constructor(popupSelector, submitFormHandler) {
    ...
    this._submitBtnText = this.buttonElement.textContent;
  }
  ...
  // Публичный метод, который меняет текст кнопки сабмита
  renderLoading(isLoading, loadingText = 'Сохранение...') {
    if (isLoading) {
      this.buttonElement.textContent = loadingText;
    } else {
      this.buttonElement.textContent = this._submitBtnText;
    }
  }
